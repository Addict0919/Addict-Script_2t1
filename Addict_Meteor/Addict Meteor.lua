...
Meteor = "Addict Meteor V2.3"
discord = "discord.gg/3Jj72cqBGw"
...
localparents["Addict Meteor"] = menu.add_feature("Addict Meteor", "parent", 0)

localparents["Local"] = menu.add_feature("Local", "parent", localparents["Addict Meteor"].id)
...
localparents["Online"] = menu.add_feature("Online", "parent", localparents["Addict Meteor"].id)
...
localparents["Spawner"] = menu.add_feature("Spawner", "parent", localparents["Addict Meteor"].id)
