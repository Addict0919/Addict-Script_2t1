...
𝓒𝓪𝓷𝓭𝔂 adding crashes and some other things
Jrukii updating/fixing alot of stuff and adding more features to the menu
...
menu.notify("Loaded Script Successfully!\n\n" .. AddictScript .. " for 2Take1 " .. discord, AddictScript, 6, NotifyColours["green"])